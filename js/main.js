...
(function($) {
	...
	// Simplify initial page entrance for faster load feel.
   ...
   $.Scrollax();
	...
	var contentWayPoint = function() {
		...
		$('.ftco-animate').each(function(index){
			if (!$(this).attr('data-animate-effect')) {
				...
				$(this).attr('data-animate-effect', effect);
			}
		});
	...
	// Disable waypoint-based reveal animation to reduce load time and keep page rendering smoother.
	// contentWayPoint();
